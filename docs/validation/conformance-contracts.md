...
Query için portable ABI/tampon testleri ve gerçek Windows API kullanan özel fixture vardır; platform kaynak profili için GTA gözlemi ayrıca gerekir. 126/127 ANSI-byte sınırı, yanlış dizin ve stack/SEH/lock/cookie değişimleri kabulü belirler. OS arşivindeki hash eşleşmesi canlı query kanıtı değildir. [Sözleşme, kaynak ve güncel kanıt](../development/d1-cwd-query.md).
