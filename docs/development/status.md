...
Bu kaynak yayını D1'i kapatmaz; D2 oynanabilir multiplayer veya native binary release değildir. Sonraki eşzamanlı proxy geliştirmesi bu doğrulanmış kaynak commit'inin kapsamı dışındadır.
